...
```{r plot, echo=FALSE, fig.align='left', fig.cap="Monthly Ozone, 2018", fig.height=3.5, message=FALSE, warning=FALSE, fig.width=5.5}
...
```{r, echo=FALSE, fig.align='left', fig.cap="Monthly Ozone, 2019", fig.height=3.5, message=FALSE, warning=FALSE, fig.width=5.5}
...
## Git Repository
https://github.com/christalzheng/EDE_Fall2023