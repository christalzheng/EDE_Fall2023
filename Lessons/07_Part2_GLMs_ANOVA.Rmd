...
qqnorm(Litter.Totals$dryMass); qqline(Litter.Totals$dryMass) # not follow normal
...
Litter.Totals.groups # same letter are not significant different, a/ab same mean
