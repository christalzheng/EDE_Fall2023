...
#Read packages
library(tidyverse);library(lubridate); library(here) # working file

#Read in data, don't convert strings to factors
sites <- read.csv(here('Data','Raw/NWIS_SiteFlowData_NE_Raw.csv')) # forcing everything is what wanted
dim(sites)
