...
```{r geom_point/subset/facet, fig.height = 3, fig.width = 4, warning = FALSE}
# Scatterplot
...
```{r scale reverse/trend line, fig.height = 3, fig.width = 4, warning = FALSE}
# Scatterplot
lightvsDO <- 
...
```{r boxplot/violin/frequency, fig.height = 3, fig.width = 4, warning = FALSE}
# Box and whiskers plot
Nutrientplot3 <-
  ggplot(PeterPaul.chem.nutrients.gathered, aes(x = lakename, y = concentration)) +
  geom_boxplot(aes(color = nutrient)) # Why didn't we use "fill"?  fill only change filling
print(Nutrientplot3)
